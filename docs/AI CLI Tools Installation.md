...
- **VS Code Extension:** Search for "Gemini CLI Companion" in the Visual Studio Code Marketplace, or install directly from [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=Google.gemini-cli-vscode-ide-companion)
...
5. **Try a game prompt** from the `/prompts/` folder in this repository
